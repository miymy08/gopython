...
--
-- Host: 127.0.0.1
-- Generation Time: May 02, 2019 at 07:16 AM
...
--
ALTER TABLE `chapter`
  MODIFY `chp_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
...
--
ALTER TABLE `exercise_chapter`
  MODIFY `exchp_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
--
...
--
ALTER TABLE `sub_chapter`
  MODIFY `subchp_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
--
...
--
ALTER TABLE `user_progress`
  MODIFY `up_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
